document.addEventListener("DOMContentLoaded", function () {
    ...
    var DGUSTGOPOL = L.geoJson(DGUPOI, {
        ...
        onEachFeature: function(feature, layer){
            var popupContent = "<p>Pruga <strong> M402</strong></p><p>Broj poligona " + feature.properties.Broj točke + " </p><p>Opis poligona " + feature.properties.Opis_kod + " </p><p>E (HTRS96/TM) " + feature.properties.E_HTRS96_TM + "," + feature.properties.N_HTRS96_TM + "</p><p>Kota HVRS71 " + feature.properties.Visina_HVRS71 + " </p><p>Kota (Trst) " + feature.properties.Visina + " </p>";
    ...
    var DGUSTGOREP = L.geoJson(DGUPOI, {
        ...
        onEachFeature: function(feature, layer){
            var popupContent = "<p>Pruga <strong> M402</strong></p><p>Broj poligona " + feature.properties.Broj točke + " </p><p>Opis repera " + feature.properties.Opis_kod + " </p><p>E (HTRS96/TM) " + feature.properties.E_HTRS96_TM + "," + feature.properties.N_HTRS96_TM + "</p><p>Kota HVRS71 " + feature.properties.Visina_HVRS71 + " </p><p>Kota (Trst) " + feature.properties.Visina + " </p>";
